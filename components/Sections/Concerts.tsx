...
import { CONCERTS_DATA } from "../../constants";
    ...
    <div className="w-full h-full pt-20 pb-20 overflow-y-auto no-scrollbar relative max-w-6xl mx-auto px-4">
            ...
            return (
              ...
              >
                      ...
                      <div className="flex flex-col bg-black/60 backdrop-blur-md rounded-lg overflow-hidden border border-white/5">
                        ...
                        <div className="relative aspect-video overflow-hidden">
                          ...
                          <div className="absolute top-3 left-3 bg-black/80 px-2 py-1 border border-white/10 rounded">
                            <span className="text-[7px] font-syncopate text-white/50 tracking-widest">
                              {concert.year}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="p-5 md:p-6">
                          ...
                          <div className="mt-4 pt-4 border-t border-white/5 flex justify-between items-center">
                            <span className="text-[8px] font-syncopate text-white/30 tracking-[0.2em]">
                              FULL_SHOW
                            </span>
                            <a
                              href={concert.url}
                ...
                <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center justify-center">
                  ...
                  >
                    <span className="text-[8px] font-syncopate font-bold text-white">
                      {concert.year ? concert.year.slice(2) : "XX"}
                    </span>
                  </motion.div>
                </div>
      ...
      <div className="mt-24 text-center">
        <div className="inline-block px-8 py-3 border border-white/10 rounded-full backdrop-blur-sm">
          <p className="text-[10px] font-syncopate tracking-[0.4em] text-white/40 uppercase">
            Arena & Stadium Tours
          </p>
        </div>
      </div>
